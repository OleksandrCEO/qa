  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-lg font-semibold">Повний запис</DialogTitle>
        </DialogHeader>
        
        <div className="space-y-6 mt-4">
          <div>
            <h3 className="text-sm font-medium text-muted-foreground mb-2">Запитання</h3>
          ...
          <div>
            <h3 className="text-sm font-medium text-muted-foreground mb-2">Відповідь</h3>
